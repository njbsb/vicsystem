                        ...
                        <div class="row justify-content-center">
                            <?php if ($plan['academicdesc']) : ?>
                                <?php foreach ($plan['academicdesc'] as $desc) : ?>
                                    <img data-toggle="tooltip" title="<?= $academicbadge['title'] ?>" class="rounded-circle" style="object-fit:cover;" src="<?= $academicbadge['photo'] ?>" alt="" width="60px" height="60px">&nbsp;
                                <?php endforeach ?>
                            <?php endif ?>
                        </div>
                        <br>
                        ...
                        <div class="row justify-content-center">
                            <?php if ($plan['activitydesc']) : ?>
                                <?php foreach ($plan['activitydesc'] as $desc) : ?>
                                    <img data-toggle="tooltip" title="<?= $activitybadge['title'] ?>" class="rounded-circle" style="object-fit:cover;" src="<?= $activitybadge['photo'] ?>" alt="" width="60px" height="60px">&nbsp;
                                <?php endforeach ?>
                            <?php endif ?>
                        </div>
                        <br>
                        ...
                        <div class="row justify-content-center">
                            <?php if ($plan['externaldesc']) : ?>
                                <?php foreach ($plan['externaldesc'] as $desc) : ?>
                                    <img data-toggle="tooltip" title="<?= $externalbadge['title'] ?>" class="rounded-circle" style="object-fit:cover;" src="<?= $externalbadge['photo'] ?>" alt="" width="60px" height="60px">&nbsp;
                                <?php endforeach ?>
                            <?php endif ?>
                        </div>
                        <br>
