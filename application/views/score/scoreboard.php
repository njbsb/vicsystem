...
<div class="jumbotron" style="border-radius:1rem; padding-top:0.75rem">
    ...
    <!-- <p>More info</p> -->
    <p class="lead">
        <a class="btn btn-info" href="<?= site_url('score/download_badgeboard') ?>" target="_blank">Download</a>
    </p>
    <table id="badgeboard" class="table">
        <thead>
...
<div class="jumbotron" style="border-radius:1rem; padding-top:0.75rem">
    ...
    <p class="lead">
        ...
        <a class="btn btn-info" href="<?= site_url('score/download_scoreboard') ?>" target="_blank">Download</a>
    </p>
