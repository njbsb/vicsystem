...
<div id="committees" class="card">
    <div class="card-body">
        <?php if ($isHighcom or $this->session->userdata('user_type') == 'mentor') : ?>
            <div class="form-group">
                <a data-toggle="modal" data-target="#add_actcommittee" class="btn btn-dark"><i class='fas fa-user-plus'></i> Add</a>
            </div>
        <?php endif ?>
                        ...
                        <?php foreach ($committees as $com) : ?>
                            ...
                            <tr>
                                ...
                                <?php if ($isHighcom or ($this->session->userdata('username') == $activity['advisor_id'])) : ?>
                                    ...
                                    <td><button data-toggle="modal" data-target="#delete_committee" data-studentid="<?= $com['student_id'] ?>" data-name="<?= $com['name'] ?>" data-role="<?= $com['role'] ?>" data-roleid="<?= $com['role_id'] ?>" class="btn-sm btn btn-outline-danger" <?= $disabled ?>>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-dark">Add committee</button>
