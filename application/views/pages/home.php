<div class="card margin">
    <div class="card-body justify-content-center">
        <div class="text-center" style="text-align: center;">
            <h3 class="home-title">Magic Flick!</h3>
            <h5>An innovative solution to manage your SIG!</h5>
            <img class="center" style="max-width: 100%; max-height: 100%; display: block; object-position: center;" src="<?= base_url('assets/images/login.png') ?>" alt="">
            - Developed for Video Innovation Club, FTSM UKM -
        </div>
    </div>
</div>
...
<div>
    <figure class="text-center">
        <blockquote class="blockquote">
            <p class="mb-0">Club management, simplified.</p>
        </blockquote>
