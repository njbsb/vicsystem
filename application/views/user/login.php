    ...
    <div class="col-md-4 col-sm-8">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <button disabled type="submit" id="submitbtn" class="btn btn-dark btn-block">Login</button>
                <?= form_close() ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>You are a:</p>
                <?= form_open('register') ?>
                <button name="usertype" type="submit" class="btn btn-dark" value="student">Student</button>&nbsp;
                <button name="usertype" type="submit" class="btn btn-dark" value="mentor">Mentor</button>
                <?= form_close() ?>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-dark" id="submitforgot" type="submit" disabled>Submit</button>
            </div>
            <?= form_close() ?>
        </div>
    </div>
