...
<div class="card">
    <div class="container">
        ...
        <?= form_close() ?>
        <small>Get user upload template <a href="<?= site_url('filelink') ?>">here</a> or download right away <a target="_blank" href="<?= site_url('user/download_template') ?>">here</a></small>
    </div>
</div>
